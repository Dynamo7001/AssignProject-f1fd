[AssignProject-f1fd] Operating Details
====================================

Generated On: 2024-10-31 14:59:44 UTC
...
.. important::
   ...
   **not be valid if your [AssignProject-f1fd] container is NOT running**.

.. tip::
   You must have your [AssignProject-f1fd] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=38793  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Dynamo7001'  \-\-env DOCKERUSERNAME='hooluwole'  \-\-env MQTTUSERNAME='hammed'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hooluwole/AssignProject-f1fd-amd64 (https://hub.docker.com/r/hooluwole/AssignProject-f1fd-amd64)
...
.. important::
   docker run -d -p 46737:46737 -p 34387:34387 -p 52301:52301 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=AssignProject-f1fd \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-AssignProject-f1fd \-\-env GITUSERNAME=Dynamo7001  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi \-\-env SOLUTIONEXTERNALPORT=46737  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=34387  \-\-env SOLUTIONVIPERVIZPORT=52301 \-\-env DOCKERUSERNAME='hooluwole' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=38793 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hammed' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hooluwole/AssignProject-f1fd-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=52301
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=46737
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hooluwole/AssignProject-f1fd-amd64
...
It can be accessed by entering: http://localhost:34387
...
.. important::
   http://localhost:52301/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:52301/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:52301/<html file>
...
[AssignProject-f1fd] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Dynamo7001/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/AssignProject-f1fd
...
.. important::
   https://AssignProject-f1fd.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-AssignProject-f1fd
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=46737, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39279, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45095, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33685, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43943, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=39899, HPDEHOST=127.0.1.1, HPDEPORT=41837, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45315

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3051-AssignProject-f1fd,solution_preprocessing_ai_mqtt_dag-AssignProject-f1fd, python-preprocess-2272-AssignProject-f1fd,solution_preprocessing_ai_mqtt_dag-AssignProject-f1fd, python-ai-9369-AssignProject-f1fd,solution_preprocessing_ai_mqtt_dag-AssignProject-f1fd, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
